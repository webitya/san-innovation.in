      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Let's discuss which services are right for your business. Contact San Innovation today for a free
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-6 max-w-2xl mx-auto">
            <h3 className="text-xl font-semibold mb-4">Contact San Innovation</h3>
